...
|-|-|-|-|
|2023.06|СИ электрических и магнитных величин|[Измерители параметров электрического и магнитного полей промышленной частоты ВЕ-50 и «ВЕ-метр» модификации «50 Гц»: проверка соответствия действительных метрологических характеристик значениям, нормированным при утверждении типов средств измерений](https://vk.com/@metrazbor-be-50)|Исследование метрологических характеристик|
